...
def view_reconstruction(filename: str, filter_thresh = 0.1, filter_count=2):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--filter_threshold", type=float, default=0.005) # experiment with
    parser.add_argument("--filter_count", type=int, default=2) #3 too strict
